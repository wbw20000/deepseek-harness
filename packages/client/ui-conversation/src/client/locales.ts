...
export const zh = {
  ...
  'input.stop': '停止生成',
  'input.stopAll': '全部停止',
  'input.stopAll.title': '全部停止？',
  'input.stopAll.description.queued': '将停止当前回合并清空 {count} 条排队消息；在你再次发送前不会自动开始新回合。',
  'input.stopAll.description.empty': '将停止当前回合，当前没有排队消息；在你再次发送前不会自动开始新回合。',
  'input.stopAll.acknowledge': '我已了解，停止并清空',
  'input.stopAll.confirm': '全部停止',
  'input.stopAll.cancel': '取消',
  'input.stopAll.close': '关闭',
  'input.stopAll.done': '已全部停止，丢弃 {count} 条排队消息',
  'input.stopAll.done.none': '已全部停止，没有排队消息',
  'stopAll.banner': '已全部停止：发送新消息后恢复',
  'stopAll.banner.close': '关闭已全部停止横幅',
  'input.send': '发送消息',
...
export const en = {
  ...
  'input.stopAll': 'Stop all',
  'input.stopAll.title': 'Stop everything?',
  'input.stopAll.description.queued': 'Stops the current turn and clears {count} queued messages; nothing starts again until you send a new message.',
  'input.stopAll.description.empty': 'Stops the current turn; no messages are queued. Nothing starts again until you send a new message.',
  'input.stopAll.acknowledge': 'I understand; stop and clear',
  'input.stopAll.confirm': 'Stop all',
  'input.stopAll.cancel': 'Cancel',
  'input.stopAll.close': 'Close',
  'input.stopAll.done': 'Fully stopped; discarded {count} queued messages',
  'input.stopAll.done.none': 'Fully stopped; no queued messages',
  'stopAll.banner': 'Fully stopped: sending a new message resumes',
  'stopAll.banner.close': 'Dismiss the fully-stopped banner',
