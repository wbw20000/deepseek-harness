...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-phone-pairing PhonePairingPanel',
      'client-ui-self-development SelfDevelopmentPanel id \'self-development\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-workspace DeepLinkNotice id \'@deepseek-ai/dsh-client-ui-workspace\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-self-development SelfDevelopmentPanel',
