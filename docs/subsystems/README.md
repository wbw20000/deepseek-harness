...
| [notify.md](notify.md) | the notify subsystem: `NotificationEvent` sanitization, the fixed session-event mapping, dedupe with failure dominance, and the outbound-command delivery contract |
